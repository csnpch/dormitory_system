...
function dateFormat(date) {
    ...
    date = date.split("-");
    return date[2] +" "+ month[(parseInt(date[1])-1)] +" "+ (parseInt(date[0]) + 543);
}

async function getData() {
    data = {
        fullname:   document.forms["data"]["fullname"].value,
        idcard:     document.forms["data"]["idcard"].value,
        nickname:   document.forms["data"]["nickname"].value,
        faculty:    document.forms["data"]["faculty"].value,
        branch:     document.forms["data"]["branch"].value,
        idstd:      document.forms["data"]["idstd"].value,
        birthday:   dateFormat(document.forms["data"]["birthday"].value),
        religion:   document.forms["data"]["religion"].value,
        blood:      document.forms["data"]["blood"].value,
        tel:        document.forms["data"]["tel"].value,
        eduAcademy: document.forms["data"]["eduAcademy"].value,
        eduDegree:  document.forms["data"]["eduDegree"].value,
        eduComple:  document.forms["data"]["eduComple"].value,
        address:    document.forms["data"]["address"].value,
        
        fam1_fullname:  document.forms["data"]["fam1_fullname"].value,
        fam1_career:    document.forms["data"]["fam1_career"].value,
        fam1_status:    document.forms["data"]["fam1_status"].value,
        fam1_work_at:   document.forms["data"]["fam1_work_at"].value,
        fam1_tel:       document.forms["data"]["fam1_tel"].value,

        fam2_fullname:  document.forms["data"]["fam2_fullname"].value,
        fam2_career:    document.forms["data"]["fam2_career"].value,
        fam2_status:    document.forms["data"]["fam2_status"].value,
        fam2_work_at:   document.forms["data"]["fam2_work_at"].value,
        fam2_tel:       document.forms["data"]["fam2_tel"].value,

        sponsor_status: document.forms["data"]["sponsor_status"].value,
        sponsor_name:   document.forms["data"]["sponsor_name"].value,
...
async function getAppendData() {
    dataAppend = {
        fullname_teacher_new:   document.forms["dataAppend"]["txt_fullname_teacher_new"].value,
        tel_teacher_new:        document.forms["dataAppend"]["txt_tel_teacher_new"].value,
        fullname_teacher_old:   document.forms["dataAppend"]["txt_fullname_teacher_old"].value,
        telHome:                document.forms["dataAppend"]["txt_tel_home"].value,
        disease:                document.forms["dataAppend"]["txt_disease"].value,
        fam1_age:               document.forms["dataAppend"]["txt_fam_age_1"].value,
        fam2_age:               document.forms["dataAppend"]["txt_fam_age_2"].value,
        fam1_salary:            document.forms["dataAppend"]["txt_fam_salary_1"].value,
        fam2_salary:            document.forms["dataAppend"]["txt_fam_salary_2"].value,
        sibling:                document.forms["dataAppend"]["txt_sibling"].value,
        sibling_male:           document.forms["dataAppend"]["txt_sibling_male"].value,
        sibling_female:         document.forms["dataAppend"]["txt_sibling_female"].value
    }
    
    let dataAppend_serilized = JSON.stringify(dataAppend);
    localStorage.setItem("dataAppend", dataAppend_serilized);
}

function getLocalStorage() {
    let dataAppend_serilized = JSON.parse(localStorage.getItem("dataAppend"));
    let strData = [
                    ['fullname_teacher_new', 'txt_fullname_teacher_new'],
                    ['tel_teacher_new', 'txt_tel_teacher_new'],
                    ['fullname_teacher_old', 'txt_fullname_teacher_old'],
                    ['telHome', 'txt_tel_home'],
                    ['disease', 'txt_disease'],
                    ['fam1_age', 'txt_fam_age_1'],
                    ['fam2_age', 'txt_fam_age_2'],
                    ['fam1_salary', 'txt_fam_salary_1'],
                    ['fam2_salary', 'txt_fam_salary_2'],
                    ['sibling', 'txt_sibling'],
                    ['sibling_male', 'txt_sibling_male'],
                    ['sibling_female', 'txt_sibling_female']
                  ];
    // console.log(dataAppend_serilized);
    for (let i = 0; i < strData.length; i++) {
        try {
            if ((dataAppend_serilized[strData[i][1]] === NaN) || (dataAppend_serilized[strData[i][1]] === undefined) || (dataAppend_serilized[strData[i][1]] === 'undefined')) {
                dataAppend_serilized[strData[i][1]] = '';
            }
            document.forms["dataAppend"][strData[i][1]].value = dataAppend_serilized[strData[i][0]]; 
...
async function checkData() {
    // SPONSOR
    switch (parseInt(data['sponsor_status'])) {
        case 0:
        case 1:
        case 10:
            data["sponsor_name"] = "";  // setting_PDF['status_sponsor']['pos_x'] = 29.6;
            break;                      // setting_PDF['howmush']['pos_x'] = 80.69;
        default:
            setting_PDF['status_sponsor']['pos_x'] = 125.4;
            setting_PDF['howmush']['pos_x'] = 174;
            break;
    }

    // DISEASE
    switch (parseInt(dataAppend["disease"].length)) {
        case 0: setting_PDF['status_disease']['pos_x'] = 61.38;
            break;
        default: setting_PDF['status_disease']['pos_x'] = 93.5;
    }

    // STATUS FAMILY
    switch (parseInt(data['fam1_status'])) { case 0: setting_PDF['status_fam1']['pos_x'] = 177.2; }
    switch (parseInt(data['fam2_status'])) { case 0: setting_PDF['status_fam2']['pos_x'] = 176.7; }
    
    if (data['faculty'].length > 24) {
        setting_PDF['faculty']['pos_y'] = 58.5;
        setting_PDF['faculty']['fontSize'] = 12;
    }

    if (data['address'].length > 100) {
        setting_PDF['address']['alignment'] = "left";
        setting_PDF['address']['pos_x'] = 24;
    }

    if (data['eduAcademy'].length > 36) {
        setting_PDF['eduAcademy']['pos_y'] = 90.4;
        setting_PDF['eduAcademy']['fontSize'] = 10;
    }

    if (data['fam1_work_at'].length > 42) {
        setting_PDF['work_at_fam1']['pos_y'] = 147.8;
        setting_PDF['work_at_fam1']['fontSize'] = 12;
        setting_PDF['work_at_fam1']['alignment'] = "left";
    }

    if (data['fam2_work_at'].length > 42) {
        setting_PDF['work_at_fam2']['pos_y'] = 162.8;
        setting_PDF['work_at_fam2']['fontSize'] = 12;
        setting_PDF['work_at_fam2']['alignment'] = "left";
    }
}
...
const ReportPDF = async () => {
        ...
        "schemas": [
            {
                ...
                "faculty": {
                    ...
                    "position": {
                        "x": 53.69,
                        "y": setting_PDF['faculty']['pos_y']
                    },
                    "width": 45.84,
                    "height": 6.2,
                    "alignment": "center",
                    "fontSize": setting_PDF['faculty']['fontSize'],
                    "characterSpacing": 0,
                    "lineHeight": 1
                },
                "branch": {
                ...
                "eduAcademy": {
                    ...
                    "position": {
                        "x": 56.1,
                        "y": setting_PDF['eduAcademy']['pos_y']
                    },
                    "width": 46.9,
                    "height": 7,
                    "alignment": "center",
                    "fontSize": setting_PDF['eduAcademy']['fontSize'],
                    "characterSpacing": 0,
                    "lineHeight": 1
                },
                "eduDegree": {
                ...
                "address": {
                    "type": "text",
                    "position": {
                        "x": setting_PDF['address']['pos_x'],
                        "y": 105.2
                    },
                    "width": 179.71,
                    "height": 7,
                    "alignment": setting_PDF['address']['alignment'],
                    "fontSize": 15,
                    "characterSpacing": 0,
                    "lineHeight": 1.4
                },
                ...
                "fam1_status": {
                    "type": "text",
                    "position": {
                        "x": setting_PDF['status_fam1']['pos_x'],
                        "y": 137.8
                    },
                    "width": 4.57,
                    "height": 7,
                ...
                "fam1_work_at": {
                    ...
                    "position": {
                        "x": 40.48,
                        "y": setting_PDF['work_at_fam1']['pos_y']
                    },
                    "width": 54.31,
                    "height": 7,
                    "alignment": setting_PDF['work_at_fam1']['alignment'],
                    "fontSize": setting_PDF['work_at_fam1']['fontSize'],
                    "characterSpacing": 0,
                    "lineHeight": 0.75
                },
                "fam1_salary": {
                ...
                "fam2_status": {
                    "type": "text",
                    "position": {
                        "x": setting_PDF['status_fam2']['pos_x'],
                        "y": 152.8
                    },
                    "width": 4.57,
                    "height": 7,
                ...
                "fam2_work_at": {
                    ...
                    "position": {
                        "x": 40.48,
                        "y": setting_PDF['work_at_fam2']['pos_y']
                    },
                    "width": 54.31,
                    "height": 7,
                    "alignment": setting_PDF['work_at_fam2']['alignment'],
                    "fontSize": setting_PDF['work_at_fam2']['fontSize'],
                    "characterSpacing": 0,
                    "lineHeight": 0.75
                },
                "fam2_salary": {
                ...
                "sponsor_status": {
                    "type": "text",
                    "position": {
                        "x": setting_PDF['status_sponsor']['pos_x'],
                        "y": 184.2
                    },
                    "width": 5.63,
                    "height": 7,
                ...
                "status_disease": {
                    "type": "text",
                    "position": {
                        "x": setting_PDF['status_disease']['pos_x'],
                        "y": 122.4
                    },
                    "width": 6.41,
                    "height": 5.94,
    ...
    const inputs = [
        { 
            ...
            "blood":        data['blood'],
            "tel":          data['tel'],
            "eduAcademy":   data['eduAcademy'],
            "eduDegree":    data['eduDegree'],
            "eduComple":    data['eduComple'],
            "address":      data['address'],
            
            "fam1_fullname":    data['fam1_fullname'],
            "fam1_career":      data['fam1_career'],
            "fam1_status": "X",
            "fam1_work_at":     data['fam1_work_at'],
            "fam1_tel":         data['fam1_tel'],
            
            "fam2_fullname":    data['fam2_fullname'],
            "fam2_career":      data['fam2_career'],
            "fam2_status": "X",
            "fam2_work_at":     data['fam2_work_at'],
            "fam2_tel":         data['fam2_tel'],

            "sponsor_status": "X",
            "howmush":          data['howmush'],
            "other_sponsor":    data["sponsor_name"],

            "name_signature":   data['fullname'],
            "room_name":        data['room_name'],
      
            "fullname_teacher_new": dataAppend['fullname_teacher_new'],
            "tel_teacher_new":      dataAppend['tel_teacher_new'],
            "fullname_teacher_old": dataAppend['fullname_teacher_old'],
            "tel_home":             dataAppend['tel_home'],
            "disease":              dataAppend['disease'],
            "status_disease":       "X",
            "fam1_salary":          dataAppend['fam1_salary'],
            "fam2_salary":          dataAppend['fam2_salary'],
            "fam1_age":             dataAppend['fam1_age'],
            "fam2_age":             dataAppend['fam2_age'],
            "sibling":              dataAppend['sibling'],
            "sibling_male":         dataAppend['sibling_male'],
            "sibling_female":       dataAppend['sibling_female']
